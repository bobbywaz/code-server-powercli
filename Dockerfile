...
RUN wget -O /root/powershell.deb -o /root/powershell_install_log https://github.com/PowerShell/PowerShell/releases/download/v7.0.3/powershell_7.0.3-1.ubuntu.18.04_amd64.deb
#   Install Powershell and exit with code 0 due to missing dependencies
RUN sudo dpkg -i /root/powershell.deb; exit 0
#   Force Powershell installation after dkpg errors
